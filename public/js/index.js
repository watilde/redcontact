...
},{"../models/users":5,"../views/item.html":6,"jquery":7,"lodash":8}],3:[function(require,module,exports){
module.exports = function () {
...
},{"./controllers/add-user":1,"./controllers/list":2,"./helpers/dialog":3,"jquery":7}],5:[function(require,module,exports){
var $ = require('jquery')
function Users () {
  this.store = []
}
